...
export const LANDMARKS = [
  { name: '냉장고', x: 8, y: 5, desc: '치즈케이크가 사라진 곳. 빈 접시만 덩그러니 놓여 있다.' },
  { name: '식탁', x: 16, y: 16, desc: '여섯 명이 함께 식사하는 넓은 원목 식탁이다.' },
  { name: '난로', x: 22, y: 3, desc: '은은한 온기가 남아 있는 거실 벽난로다.' },
  { name: '서재 책상', x: 24, y: 24, desc: '공부와 작업을 위한 책상이다. 펼쳐진 책과 램프가 있다.' },
  { name: '책장', x: 20, y: 20, desc: '소설, 전공 서적, 잡지가 빼곡하게 꽂혀 있다.' },
  { name: '현관', x: 16, y: 24, desc: '집 안팎을 잇는 현관문이다.' },
  { name: '데크', x: 3, y: 12, desc: '햇볕이 잘 드는 야외 데크. 파라솔이 펼쳐져 있다.' },
  { name: '운동장', x: 2, y: 24, desc: '덤벨과 운동 매트가 놓인 야외 운동 공간이다.' },
  { name: '텃밭', x: 30, y: 21, desc: '신선한 채소와 허브가 자라고 있는 텃밭이다.' },
  { name: '헛간', x: 29, y: 6, desc: '원예 도구와 보관 상자들이 차곡차곡 쌓여 있다.' },
  { name: '아일랜드', x: 8, y: 10, desc: '주방 조리대. 과일 바구니와 찻잔이 놓여 있다.' },
  { name: '소파', x: 26, y: 10, desc: '편안하게 쉴 수 있는 거실 코너 소파다.' },
];
